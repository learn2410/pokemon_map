...
Создайте учетную запись администратора базы командой:
```sh
python manage.py createsuperuser
```

Загрузить демонстрационные данные в базу (если нет желания вводить все вручную) можно командоой: 
```sh
python manage.py loaddata sample.json
``` 
- при этом изображения все равно придется обновить самостоятельно чарез панель администратора (картинки  желательно ставить в формате PNG с прозрачным фоном )
